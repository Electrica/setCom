...
class setComOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('setcom_item_err_ns');
        }
...
return 'setComOfficeItemUpdateProcessor';
